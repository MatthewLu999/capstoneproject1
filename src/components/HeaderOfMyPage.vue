...
<nav>
  ...
  <section>
    ...
    >
      <img src="images/logo.jpg" style="width: 3.9em; height: 3.5em; border-radius: 10px;" />&nbsp;
      <button
...
export default {
  ...
  mounted () {
    ...
    var fullname = this.getCookieforArray('username1')
    if (fullname) {
    ...
    var usrpicture = this.getCookieforArray('userpicture1')
