...
export default {
  ...
  mounted () {
    ...
    document.querySelectorAll('.level').forEach(level => {
      level.addEventListener('click', function () {
        ...
        var excerciseMode = selectedIntensity.charAt(0).toUpperCase() + selectedIntensity.slice(1)
  ...
  methods: {
    updateNumbersWatched (event) {
      ...
      var currentNumberVideo = this.getCookieforArray('todayvideowatched')
      var newNumbervideo = currentNumberVideo + this.NumberOfVideoWatched
