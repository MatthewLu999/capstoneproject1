...
export default {
  ...
  mounted () {
    var totalnews = this.getCookieforArray('todaynewswatched')
    if (totalnews) {
      this.totalreadingnews = totalnews
      this.percentageReadingnews = (totalnews / this.availablenews) * 100
    }
    // get data about watching video
    var totalvideo = this.getCookieforArray('todayvideowatched')
    if (totalvideo) {
      this.totalwatchedvideos = totalvideo
      this.percentageWatchedvideos = (totalvideo / this.availabevideo) * 100
    }
    // total achieved
    var totalAchievements = this.percentageReadingnews + this.percentageWatchedvideos
    ...
    var canvaspiechart = document.getElementById('myPieChart')
    var myPieChart = new Chart(canvaspiechart, {
      type: 'pie',
      data: {
    ...
    var canvasbarchart = document.getElementById('myChart')
    var mybarChart = new Chart(canvasbarchart, {
      type: 'bar',
      data: {
